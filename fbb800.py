...
def run_ffmpeg(video_path, stream_key, is_vertical, log_callback):
    ...
    output_url = f"rtmp://live-api-s.facebook.com:80/rtmp/{stream_key}"
...
def main():
    ...
    # ✅ Naikkan limit upload file ke 8000 MB (8 GB)
    st.config.set_option("server.maxUploadSize", 8000)
    ...
    # ✅ Stream Key Facebook Live (dari Facebook Creator Studio > Live Producer)
